  ...
  (function activeNavItem() {
    ...
    [].forEach.call(document.getElementsByClassName('nav-list-item'), function(elem) {
      if(location[location.length - 2] == elem.id) {
        addClass(elem, 'active-view-nav'); // defined in adjacent dom.js file
      }
    });
  })();
...
document.addEventListener("DOMContentLoaded", function(e) {
  ...
  function enterWaypoint() { // TODO:: refactor enterWaypoint into stand-alone helper method.
    if(!main_nav) {
      var h = home_nav.style;
      h.backgroundColor = '#48D6C3';
    } else if(!home_nav) {
      [].forEach.call(document.getElementsByClassName('nav-list-item'), function(elem) {
        elem.style.display = "none";
      });
      var b = document.getElementById('menu-marker');
      var document.getElementsByClassName('mdl-layout__drawer-button');
      document.getElementsByClassName('nav').style.backgroundColor = 'transparent';
      b.innerHTML = 'Menu';
      b.style.backgroundColor = '#FFFFFF';
      b.style.padding = "23px 23px";
      b.style.margin = '0 0 0 -12px';
      b.style.border = '1px solid #2ff7c6';
    }
  }
  function exitWaypoint(){ // TODO:: refactor exitWaypoint into stand-alone helper method.
    if(!main_nav) {
      var h = home_nav.style;
  ...
  window.addEventListener('scroll', function(e) {
    ...
    if(last_known_scroll_position > 480) {
      enterWaypoint();
    } else if(last_known_scroll_position < 480) {
      exitWaypoint();
    }
  });
});
