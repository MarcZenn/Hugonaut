...
document.addEventListener("DOMContentLoaded", function(e) {
  ...
  function enterWaypoint() { // TODO:: refactor enterWaypoint into stand-alone helper method.
    if(!main_nav) {
      ...
      document.getElementsByClassName('mdl-layout__drawer-button')[0].style.backgroundColor = '#FFFFFF';
      var b = document.getElementsByClassName('nav')[0];
      var c = document.getElementById('menu-marker');
      b.style.backgroundColor = 'transparent';
      b.style.border = 'none';
      c.innerHTML = 'Menu';
      c.style.backgroundColor = '#FFFFFF';
      c.style.padding = "23px 23px";
      c.style.margin = '0 0 0 -12px';
      c.style.border = '1px solid #2ff7c6';
    }
  }
